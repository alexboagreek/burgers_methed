import { catalogList, modalProductBtn, countAmount, orderCount, orderList, orderTotalAmount } from "./elements.js";
...
const renderCartList = async () => {
    ...
    //**вывод стоимости бургера и его количества */
...
const removeCart = (id) => {
    const cartList = getCart();
    const productIndex = cartList.findIndex((item) => item.id === )
...
const cartController = () => {
 ...
 //** добавление/уменьшение количества товара в корзине */
